...
The default `susfile` generated by `opensus init` includes common recon/web tools such as nmap, gobuster, ffuf, nuclei, nikto, hydra, and sqlmap, plus Metasploit helper tools for module search and exploit workflows.



### Metasploit helper tools

The default `susfile` now includes:
